    ...
    .then(updatedPassenger => {
        res.status(200).json({
            ...
            request:{
                ...
                type:"GET",
                URL:"https://node-js-projects-praveenck06.c9users.io/passengers/"+updatedPassenger._id
            }
        })
    })
    .catch(err => {
        ...
        if(passenger){
            res.status(200).json({
                ...
                request:{
                    ...
                    type:"GET",
                    URL:"https://node-js-projects-praveenck06.c9users.io/passengers/"
                }
            })
        }else{
            res.status(404).json({
          ...
          //   Pclass:doc.Pclass,
           ...
           //   Cabin:doc.Cabin,
               request:{
                   ...
                   type:"GET",
                   URL:"https://node-js-projects-praveenck06.c9users.io/passengers/"+doc._id
                   }
               }
